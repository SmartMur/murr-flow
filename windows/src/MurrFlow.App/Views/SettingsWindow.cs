...
using MurrFlow.App.Controls;
using MurrFlow.App.Design;
using MurrFlow.Core;
using MurrFlow.Speech;

namespace MurrFlow.App.Views;
...
public sealed class SettingsWindow : Window
{
    ...
    private static StackPanel BuildModelSection()
    {
        ...
        var detail = found
            ...
            : Note("Windows has no built-in speech engine equivalent to Apple's, so Murr-flow "
