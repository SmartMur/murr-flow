...
using MurrFlow.Abstractions;

namespace MurrFlow.App;
...
/// <remarks>
/// <para>
/// <b>Why reflection rather than a project reference:</b> <c>MurrFlow.Platform.Windows</c>
...
{
    private const string AssemblyName = "MurrFlow.Platform.Windows";
    private const string Namespace = "MurrFlow.Platform.Windows";
    ...
    /// one is deliberately invisible to it — that is what keeps <c>MurrFlow.App</c> on plain
    ...
    [UnconditionalSuppressMessage(
        ...
        Justification = "MurrFlow.Platform.Windows ships whole beside the executable and is "
    ...
    [UnconditionalSuppressMessage(
        ...
        Justification = "MurrFlow.Platform.Windows is published whole and never trimmed.")]
